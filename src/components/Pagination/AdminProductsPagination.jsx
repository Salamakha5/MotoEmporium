...
let s = adminStore
const AdminProductsPagination = observer(({ shortPagination, dataLength }) => {
    ...
    return (
        <div>
            <ul className={shortPagination == true && adminStore.productsCountPages >= 6 ? 'pagination pagination_short' : 'pagination'}>
