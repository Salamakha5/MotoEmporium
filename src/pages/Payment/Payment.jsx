...
const Payment = () => {
  ...
  const contactformik = useFormik({
    ...
    validationSchema: Yup.object({
      fullName: Yup.string().required(t('yupErrors.required'))
        .min(4, t('yupErrors.valid-field', { num: 4 })).max(40, t('yupErrors.valid-maxLength', { num: 40 })),
      ...
      departament: Yup.string().required(t('yupErrors.required'))
        .min(2, t('yupErrors.valid-field', { num: 2 })).max(50, t('yupErrors.valid-maxLength', { num: 50 })),
    })
  })
  ...
  const cardformik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      expirationMM: Yup.string().required(t('yupErrors.required')).matches(/^[0-9]{2}$/gm, 'Invalid MM'),
  ...
  function lengthLimit(event, num) {
          ...
          <div className="details">
            ...
            <form className="form">
              ...
              <div className='contact-details'>
                ...
                <div className='inputsCont'>
                  <input className='forms_bot_line | form-control' type="text" placeholder={t('payment_page.contactDetails.number_phone')}
                    name="phoneNumber" onChange={contactformik.handleChange} value={contactformik.values.phoneNumber}
                    onKeyPress={(event) => lengthLimit(event, 10)}
                  />
              ...
              <div className='card-data'>
                <div className='inputsCont'>
                  <input className='forms_bot_line | form-control' type="text" placeholder={t('payment_page.cardDetails.card_number')}
                    name="cardNumber" value={cardformik.values.cardNumber}
                    onChange={cardformik.handleChange} onKeyPress={(event) => lengthLimit(event, 16)} />
                ...
                <div className='inputsCont twoInputs'>
                  <div className="left">
                    ...
                    <div className='inputs-cont'>
                      <input type="text" placeholder={t('payment_page.cardDetails.expiration-mm')} name="expirationMM"
                        ...
                        onKeyPress={(event) => lengthLimit(event, 2)} />
                  ...
                  <div className="right">
                    ...
                    <input type="text" placeholder='nnn'
                      ...
                      name="cvv" value={cardformik.values.cvv} onChange={cardformik.handleChange}
                      onKeyPress={(event) => lengthLimit(event, 3)} />
                  </div>
                </div>
              </div>
            </form>
