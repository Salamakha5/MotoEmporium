...
const Register = observer(() => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            name: Yup.string().required(t('yupErrors.required')).min(4, t('yupErrors.valid-field', { num: 4 })).max(50, t('yupErrors.valid-maxLength', { num: 50 })),
            ...
            confirmPassword: Yup.string().required(t('yupErrors.required')).min(5, t('yupErrors.valid-password', { num: 5 })).max(50, t('yupErrors.valid-maxLength', { num: 50 })),
        })
    })
